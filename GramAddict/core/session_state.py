...
class SessionState:
    ...
    startTime = None
    finishTime = None
    skipped_per_competitor = {}
    skipped_lists_per_competitor = {}
    ...
    def __init__(self, configs):
        ...
        self.total_lists_skipped = 0
        self.skipped_per_competitor = {}
        self.skipped_lists_per_competitor = {}
    ...
    def set_limits_session(
        ...
        # Set high limit for PMs
        self.args.current_pm_limit = int(3000)
    ...
    def check_limit(self, limit_type=None, output=False):
        ...
        total_skipped_reached = self.total_lists_skipped >= int(self.args.skipped_list_limit)
        ...
        session_info = [
            ...
            f"- Total Skipped Lists:\t\t{'Limit Reached' if total_skipped_reached else 'OK'} ({self.total_lists_skipped})",
        ]
        ...
        elif limit_type == SessionState.Limit.SKIPPED_LISTS:
            if output:
                logger.info(session_info[11])
            else:
                logger.debug(session_info[11])
            return total_skipped_reached
...
class SessionStateEncoder(JSONEncoder):
    def default(self, session_state: SessionState):
        return {
            ...
            "skipped_lists": session_state.total_lists_skipped,

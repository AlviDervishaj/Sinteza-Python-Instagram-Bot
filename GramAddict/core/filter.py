...
class Filter:
    ...
    def return_check_profile(self, username, profile_data, skip_reason=None, view_story=True) -> bool:
        """
    ...
    def check_profile(self, device, username, dont_filter=False, my_username=None, _competitor=None):
        """
        ...
        if profile_data.is_restricted:
            ...
            if _competitor in self.skipped_per_competitors:
                    self.skipped_per_competitors[_competitor] += 1
            else:
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.RESTRICTED, False
            ), self.skipped_per_competitors
        if profile_data.follow_button_text == FollowStatus.NONE or None in (
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.NOT_LOADED, False
            ), self.skipped_per_competitors
        ...
        if (
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.YOU_FOLLOW, False
            ), self.skipped_per_competitors
        ...
        if (
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.FOLLOW_YOU, False
            ), self.skipped_per_competitors
        logger.debug(
        ...
        if profile_data.is_private and field_skip_if_public:
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.IS_PUBLIC, False
            ), self.skipped_per_competitors
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.IS_PRIVATE, False
            ), self.skipped_per_competitors
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.UNKNOWN_PRIVACY, False
            ), self.skipped_per_competitors
        ...
        if field_min_followers is not None and profile_data.followers < int(
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.LT_FOLLOWERS, False
            ), self.skipped_per_competitors
        if field_max_followers is not None and profile_data.followers > int(
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.GT_FOLLOWERS, False
            ), self.skipped_per_competitors
        if field_min_followings is not None and profile_data.followings < int(
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.LT_FOLLOWINGS, False
            ), self.skipped_per_competitors
        if field_max_followings is not None and profile_data.followings > int(
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.GT_FOLLOWINGS, False
            ), self.skipped_per_competitors
        ...
        if (field_min_potency_ratio != 0 or field_max_potency_ratio != 999) and (
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.POTENCY_RATIO, False
            ), self.skipped_per_competitors
        ...
        if field_mutual_friends != -1:
            ...
            if profile_data.mutual_friends < field_mutual_friends:
                ...
                return profile_data, self.return_check_profile(
                    username, profile_data, SkipReason.LT_MUTUAL, False
                )
        ...
        if field_skip_if_link_in_bio:
            ...
            if profile_data.link_in_bio is not None:
                ...
                return profile_data, self.return_check_profile(
                    username, profile_data, SkipReason.HAS_LINK_IN_BIO, False
                ), self.skipped_per_competitors
        ...
        if field_skip_business and profile_data.has_business_category is True:
            ...
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.HAS_BUSINESS, False
            ), self.skipped_per_competitors
        if field_skip_non_business and profile_data.has_business_category is False:
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.HAS_NON_BUSINESS, False
            ), self.skipped_per_competitors
        ...
        if field_min_posts is not None and field_min_posts > profile_data.posts_count:
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.NOT_ENOUGH_POSTS, False
            ), self.skipped_per_competitors
        ...
        if (
            ...
            if _competitor in self.skipped_per_competitors:
                ...
                self.skipped_per_competitors[_competitor] = 1
            return profile_data, self.return_check_profile(
                username, profile_data, SkipReason.BIOGRAPHY_IS_EMPTY, False
            ), self.skipped_per_competitors
        if (
                ...
                for w in field_blacklist_words:
                    ...
                    if blacklist_words is not None:
                        ...
                        if _competitor in self.skipped_per_competitors:
                            ...
                            self.skipped_per_competitors[_competitor] = 1
                        return profile_data, self.return_check_profile(
                            username, profile_data, SkipReason.BLACKLISTED_WORD, False
                        ), self.skipped_per_competitors
            ...
            if len(field_mandatory_words) > 0:
                ...
                if not mandatory_words and not mandatory_found:
                    ...
                    if _competitor in self.skipped_per_competitors:
                        ...
                        self.skipped_per_competitors[_competitor] = 1
                    return profile_data, self.return_check_profile(
                        username, profile_data, SkipReason.MISSING_MANDATORY_WORDS, False
                    ), self.skipped_per_competitors
            ...
            if field_specific_alphabet is not None:
                ...
                if alphabet not in field_specific_alphabet and alphabet != "":
                    ...
                    if _competitor in self.skipped_per_competitors:
                        ...
                        self.skipped_per_competitors[_competitor] = 1
                    return profile_data, self.return_check_profile(
                        username, profile_data, SkipReason.ALPHABET_NOT_MATCH, False
                    ), self.skipped_per_competitors
        ...
        return profile_data, self.return_check_profile(username, profile_data, None, True), None
